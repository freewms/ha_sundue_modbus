...
class ModbusTemperatureSensorDescription(SensorEntityDescription, EntityFactory):
    ...
    def create_entity_if_supported(
        ...
        return ModbusTemperatureSensor(controller, self, addresses, inv_details, round_to) if addresses is not None else None


class ModbusTemperatureSensor(ModbusEntityMixin, SensorEntity):
    """Sensor temperature class."""

    def __init__(
        self,
        controller: EntityController,
        entity_description: ModbusTemperatureSensorDescription,
